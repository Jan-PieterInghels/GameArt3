...
{
    public event Action<GameObject, Vector3, bool> OnHit;
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            OnHit?.Invoke(other.transform.root.gameObject, transform.root.forward, transform.root.GetComponent<PlayerBehaviour>().IsHeavy);
